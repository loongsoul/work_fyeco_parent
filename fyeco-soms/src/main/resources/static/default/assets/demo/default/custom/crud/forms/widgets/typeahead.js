var Typeahead = function() {
    ...
    return {
        init: function() {
            var a, n, o, t, i, s;
			var se = "http://localhost:8080/default/assets/demo/default/custom/crud/forms/widgets";
            ...
            o = new Bloodhound({
                datumTokenizer: Bloodhound.tokenizers.whitespace,
                queryTokenizer: Bloodhound.tokenizers.whitespace,
                prefetch: se + "/inc/api/typeahead/countries.json"
            }),
            ...
            t = new Bloodhound({
                ...
                queryTokenizer: Bloodhound.tokenizers.whitespace,
                prefetch: se + "/inc/api/typeahead/movies.json"
            }),
            ...
            i = new Bloodhound({
                ...
                queryTokenizer: Bloodhound.tokenizers.whitespace,
                prefetch: se + "/inc/api/typeahead/nba.json"
            }),
            s = new Bloodhound({
                datumTokenizer: Bloodhound.tokenizers.obj.whitespace("team"),
                queryTokenizer: Bloodhound.tokenizers.whitespace,
                prefetch: se + "/inc/api/typeahead/nhl.json"
            }),
