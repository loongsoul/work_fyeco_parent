this.Element &&
function(t) {
    t.matches = t.matches || t.matchesSelector || t.webkitMatchesSelector || t.msMatchesSelector ||
    function(t) {
...
function() {
    for (var t = 0,
    e = ["webkit", "moz"], a = 0; a < e.length && !window.requestAnimationFrame; ++a) window.requestAnimationFrame = window[e[a] + "RequestAnimationFrame"],
...
var mUtil = function() {
    ...
    return {
        ...
        addClass: function(t, e) {
            if (t && void 0 !== e) {
                var a = e.split(" ");
                if (t.classList) for (var n = 0; n < a.length; n++) a[n] && a[n].length > 0 && t.classList.add(mUtil.trim(a[n]));
        ...
        removeClass: function(t, e) {
            if (t && void 0 !== e) {
                ...
                else if (mUtil.hasClass(t, e)) for (n = 0; n < a.length; n++) t.className = t.className.replace(new RegExp("\\b" + mUtil.trim(a[n]) + "\\b", "g"), "")
            }
        },
        ...
        parents: function(t, e) {
            function a(t, e) {
                for (var a = 0,
                n = t.length; a < n; a++) if (t[a] == e) return ! 0;
                return ! 1
            }
            return function(t, e) {
        ...
        matches: function(t, e, a) {
            ...
            o = n.matches || n.webkitMatchesSelector || n.mozMatchesSelector || n.msMatchesSelector ||
            function(t) {
        ...
        css: function(t, e, a) {
            if (t = mUtil.get(t)) if (void 0 !== a) t.style[e] = a;
            else {
                var n = (t.ownerDocument || document).defaultView;
                if (n && n.getComputedStyle) return e = e.replace(/([A-Z])/g, "-$1").toLowerCase(),
                n.getComputedStyle(t, null).getPropertyValue(e);
                if (t.currentStyle) return e = e.replace(/\-(\w)/g,
                function(t, e) {
        ...
        slide: function(t, e, a, n, o) {
            if (! (!t || "up" == e && !1 === mUtil.visible(t) || "down" == e && !0 === mUtil.visible(t))) {
                ...
                "up" == e ? (t.style.cssText = "display: block; overflow: hidden;", l && mUtil.animate(0, l, a,
                function(e) {
                    t.style.paddingTop = l - e + "px"
                },
                "linear"), r && mUtil.animate(0, r, a,
                function(e) {
                ...
                })) : "down" == e && (t.style.cssText = "display: block; overflow: hidden;", l && mUtil.animate(0, l, a,
                function(e) {
        ...
        removeEvent: function(t, e, a) { (t = mUtil.get(t)).removeEventListener(e, a)
        },
        on: function(t, e, a, n) {
            if (e) {
                ...
                return mUtilDelegatedEventHandlers[o] = function(a) {
                    for (var o = t.querySelectorAll(e), i = a.target; i && i !== t;) {
                        for (var l = 0,
                        r = o.length; l < r; l++) i === o[l] && n.call(i, a);
                        i = i.parentNode
                    }
                },
        ...
        one: function(t, e, a) { (t = mUtil.get(t)).addEventListener(e,
            function(t) {
        ...
        hash: function(t) {
            ...
            for (e = 0; e < t.length; e++) a = (a << 5) - a + t.charCodeAt(e),
            a |= 0;
            return a
        },
        animateClass: function(t, e, a) {
            mUtil.addClass(t, "animated " + e),
            mUtil.one(t, "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
            function() {
        ...
        ready: function(t) { (document.attachEvent ? "complete" === document.readyState: "loading" !== document.readyState) ? t() : document.addEventListener("DOMContentLoaded", t)
        },
        isEmpty: function(t) {
        ...
        scrollerUpdate: function(t) {
            var e; (e = mUtil.data(t).get("ps")) && e.update()
        },
        ...
        scrollerDestroy: function(t) {
            var e; (e = mUtil.data(t).get("ps")) && (e.destroy(), e = mUtil.data(t).remove("ps"))
        }
    }
} ();
...
var mApp = function() {
    ...
    l = function() {
        $('[m-portlet="true"]').each(function() {
            var t = $(this); ! 0 !== t.data("portlet-initialized") && (i(t, {}), t.data("portlet-initialized", !0))
        })
    },
    r = function() {
    ...
    t.fn.mDatatable = function(n) {
        if (0 !== t(this).length) {
            ...
            var i = {
                ...
                init: function(e) {
                    var a = !1;
                    return null === e.data.source && (i.extractTable(), a = !0),
                    i.setupBaseDOM.call(),
                    i.setupDOM(o.table),
                    i.spinnerCallback(!0),
                    ...
                    t.each(i.getOption("extensions"),
                    function(e, a) {
                        "function" == typeof t.fn.mDatatable[e] && new t.fn.mDatatable[e](o, a)
                    }),
                    "remote" !== e.data.type && "local" !== e.data.type || ((!1 === e.data.saveState || !1 === e.data.saveState.cookie && !1 === e.data.saveState.webstorage) && i.stateRemove(i.stateId), "local" === e.data.type && "object" == typeof e.data.source && (o.dataSet = o.originalDataSet = i.dataMapCallback(e.data.source)), i.dataRender()),
                    a || (i.setHeadTitle(), i.getOption("layout.footer") && i.setHeadTitle(o.tableFoot)),
                    ...
                    null !== e.data.type && "local" !== e.data.type || (i.setupCellField.call(), i.setupTemplateCell.call(), i.setupSubDatatable.call(), i.setupSystemColumn.call(), i.redraw()),
                    t(window).resize(i.fullRender),
                    t(o).height(""),
                    t(i.getOption("search.input")).on("keyup",
                    function(e) {
                ...
                extractTable: function() {
                    ...
                    i = t(o).find("tr:first-child th").get().map(function(e, o) {
                        ...
                        for (var r in n.columns) n.columns[r].field === i && (l = t.extend(!0, {},
                        n.columns[r], l));
                        return a.push(l),
                        i
                    });
                                ...
                                0 === t(this).find(".m-datatable__lock").length && t(this).ready(function() { !
                                    function(a) {
                                        if (t(a).find(".m-datatable__lock").length > 0) i.log("Locked container already exist in: ", a);
                                            ...
                                            e.lockEnabled.left.length > 0 && (t(o.wrap).addClass("m-datatable--lock"), t(n).appendTo(a)),
                                            (e.lockEnabled.left.length > 0 || e.lockEnabled.right.length > 0) && t(l).appendTo(a),
                                            e.lockEnabled.right.length > 0 && (t(o.wrap).addClass("m-datatable--lock"), t(r).appendTo(a))
                ...
                afterRender: function(e, a) {
                    a.table == t(o.wrap).attr("id") && t(o).ready(function() {
                        i.isLocked() || (i.redraw(), i.getOption("rows.autoHide") && (i.autoHide(), t(o.table).find(".m-datatable__row").css("height", ""))),
                        i.rowEvenOdd.call(),
                        i.isLocked() && i.redraw(),
                ...
                setupHover: function() {
                    ...
                    t(o.tableBody).find(".m-datatable__cell").off("mouseenter", "mouseleave").on("mouseenter",
                    function() {
                ...
                setupBaseDOM: function() {
                    ...
                    "TABLE" === t(o).prop("tagName") ? (o.table = t(o).removeClass("m-datatable").addClass("m-datatable__table"), 0 === t(o.table).parents(".m-datatable").length && (o.table.wrap(t("<div/>").addClass("m-datatable").addClass("m-datatable--" + n.layout.theme)), o.wrap = t(o.table).parent())) : (o.wrap = t(o).addClass("m-datatable").addClass("m-datatable--" + n.layout.theme), o.table = t("<table/>").addClass("m-datatable__table").appendTo(o)),
                    void 0 !== n.layout.class && t(o.wrap).addClass(n.layout.class),
                    t(o.table).removeClass("m-datatable--destroyed").css("display", "block"),
                    void 0 === t(o).attr("id") && (i.setOption("data.saveState", !1), t(o.table).attr("id", e.getUniqueID("m-datatable--"))),
                    ...
                    void 0 !== n.layout.footer && n.layout.footer && (o.tableFoot = t(o.table).find("tfoot"), 0 === t(o.tableFoot).length && (o.tableFoot = t("<tfoot/>").appendTo(o.table)))
                },
                    ...
                    t(e).find(".m-datatable__row").each(function(e, n) {
                        ...
                        t(n).find(".m-datatable__cell").each(function(n, r) {
                            ...
                            if (void 0 !== s && void 0 !== s.template) {
                                ...
                                c.innerHTML = d,
                                t(r).html(c),
                                void 0 !== s.overflow && (t(c).css("overflow", s.overflow), t(c).css("position", "relative"))
                            }
                        });
                    ...
                    if (o.dataSet = o.dataSet || [], 0 !== o.dataSet.length) {
                            ...
                            t(n).find(".m-datatable__cell").each(function(a, n) {
                                ...
                                if (void 0 !== o) {
                                    ...
                                    if (void 0 !== o.selector && !1 !== o.selector) {
                                        ...
                                        var r = t("<label/>").addClass("m-checkbox m-checkbox--single").append(t("<input/>").attr("type", "checkbox").attr("value", l).on("click",
                                        function() {
                        ...
                        var a = function(a) {
                            ...
                            if (void 0 !== n && void 0 !== n.selector && !1 !== n.selector) {
                                ...
                                var l = t("<label/>").addClass("m-checkbox m-checkbox--single m-checkbox--all").append(t("<input/>").attr("type", "checkbox").on("click",
                                function() {
                ...
                setHeadTitle: function(a) {
                    ...
                    void 0 === r && (r = document.createElement("tr"), a.appendChild(r)),
                    t.each(l,
                    function(a, n) {
                        var i = s[a];
                        if (void 0 === i && (i = document.createElement("th"), r.appendChild(i)), void 0 !== n.title && (i.innerHTML = n.title, i.setAttribute("data-field", n.field), e.addClass(i, n.class), t(i).data(n)), void 0 !== n.attr && t.each(n.attr,
                        function(t, e) {
                            i.setAttribute(t, e)
                        }), void 0 !== n.textAlign) {
                ...
                dataRender: function(e) {
                    ...
                    l = function(e) {
                        var l = function(e, a) {
                            t(e.pager).hasClass("m-datatable--paging-loaded") || (t(e.pager).remove(), e.init(a)),
                            t(e.pager).off().on("m-datatable--on-goto-page",
                            function(n) {
                                t(e.pager).remove(),
                                e.init(a)
                            });
                ...
                getData: function() {
                    ...
                    if ("local" === n.data.type && (e.url = n.data.source), "remote" === n.data.type) {
                        ...
                        e.data = t.extend({},
                        e.data, a, i.getOption("data.source.read.params"))
                    }
                ...
                paging: function(a, n) {
                    var l = {
                        ...
                        init: function(e) {
                            ...
                            t(l.pager).hasClass("m-datatable--paging-loaded") || (t(l.pager).remove(), 0 !== l.meta.pages && (i.setDataSourceParam("pagination", {
                                page: l.meta.page,
                                pages: l.meta.pages,
                        ...
                        populate: function() {
                            ...
                            t("<li/>").append(t("<input/>").attr("type", "text").addClass("m-pager-input form-control").attr("title", a.input).on("keyup",
                            function() {
                            ...
                            t.each(i.getOption("toolbar.layout"),
                            function(e, a) {
                        ...
                        paste: function() {
                            t.each(t.unique(i.getOption("toolbar.placement")),
                            function(e, a) {
                        ...
                        addPaginateEvent: function(e) {
                            t(o).off(l.paginateEvent).on(l.paginateEvent,
                            function(e, a) {
                                i.spinnerCallback(!0),
                                l.pager = t(o.table).siblings(".m-datatable__pager");
                        ...
                        pagingBreakpoint: function() {
                            ...
                            if (0 !== t(a).length) {
                                ...
                                t(a).find("li").show(),
                                t.each(i.getOption("toolbar.items.pagination.pages"),
                                function(o, s) {
                        ...
                        paginationUpdate: function() {
                            ...
                            1 === l.meta.page ? (t(r).attr("disabled", !0).addClass("m-datatable__pager-link--disabled"), t(s).attr("disabled", !0).addClass("m-datatable__pager-link--disabled")) : (t(r).removeAttr("disabled").removeClass("m-datatable__pager-link--disabled"), t(s).removeAttr("disabled").removeClass("m-datatable__pager-link--disabled")),
                            l.meta.page === l.meta.pages ? (t(d).attr("disabled", !0).addClass("m-datatable__pager-link--disabled"), t(c).attr("disabled", !0).addClass("m-datatable__pager-link--disabled")) : (t(d).removeAttr("disabled").removeClass("m-datatable__pager-link--disabled"), t(c).removeAttr("disabled").removeClass("m-datatable__pager-link--disabled"));
                ...
                columnHide: function() {
                    ...
                    function(n, i) {
                        if (void 0 !== i.responsive) {
                            var l = i.field,
                            r = t.grep(t(o.table).find(".m-datatable__cell"),
                            function(e, a) {
                ...
                setupSubDatatable: function() {
                    ...
                    if ("function" == typeof e && !(t(o.table).find(".m-datatable__subtable").length > 0)) {
                        ...
                        var a = function(a) {
                            ...
                            0 === t(r).length && (r = t("<tr/>").addClass("m-datatable__row-subtable m-datatable__row-loading").hide().append(t("<td/>").addClass("m-datatable__subtable").attr("colspan", i.getTotalColumns())), t(l).after(r), t(l).hasClass("m-datatable__row--even") && t(r).addClass("m-datatable__row-subtable--even")),
                            t(r).toggle();
                            ...
                            t(l).hasClass("m-datatable__row--subtable-expanded") ? (t(c).addClass(i.getOption("layout.icons.rowDetail.collapse")), t(l).removeClass("m-datatable__row--subtable-expanded"), t(o).trigger("m-datatable--on-collapse-subtable", [l])) : (t(c).addClass(i.getOption("layout.icons.rowDetail.expand")), t(l).addClass("m-datatable__row--subtable-expanded"), t(o).trigger("m-datatable--on-expand-subtable", [l])),
                            0 === t(s).find(".m-datatable").length && (t.map(o.dataSet,
                            function(t, e) {
                                return d === t[n.columns[0].field] && (a.data = t, !0)
                            }), a.detailCell = s, a.parentRow = l, a.subTable = s, e(a), t(s).children(".m-datatable").on("m-datatable--on-init",
                            function(e) {
                ...
                autoHide: function() {
                    ...
                    var e = function(e) {
                        ...
                        o = t(a).next();
                        if (t(o).hasClass("m-datatable__row-detail")) t(this).find("i").removeClass(i.getOption("layout.icons.rowDetail.expand")).addClass(i.getOption("layout.icons.rowDetail.collapse")),
                        t(o).remove();
                        else {
                    ...
                    t(o.tableBody).find(".m-datatable__row").each(function() {
                        ...
                        0 === t(o.tableHead).find(".m-datatable__toggle-detail").length ? (t(o.tableHead).find(".m-datatable__row").first().prepend('<th class="m-datatable__cell m-datatable__toggle-detail"><span style="width: 21px"></span></th>'), t(o.tableFoot).find(".m-datatable__row").first().prepend('<th class="m-datatable__cell m-datatable__toggle-detail"><span style="width: 21px"></span></th>')) : t(o.tableHead).find(".m-datatable__toggle-detail").find("span").css("width", "21px")
                    })
                },
                hoverColumn: function() {
                    t(o.tableBody).on("mouseenter", ".m-datatable__cell",
                    function() {
                ...
                setAutoColumns: function() {
                    i.getOption("data.autoColumns") && (t.each(o.dataSet[0],
                    function(e, a) {
                        0 === t.grep(n.columns,
                        function(t, a) {
                            return e === t.field
                ...
                stateKeep: function(t, e) {
                    ...
                    !1 !== i.getOption("data.saveState") && (i.getOption("data.saveState.webstorage") && localStorage && localStorage.setItem(t, JSON.stringify(e)), i.getOption("data.saveState.cookie") && Cookies.set(t, JSON.stringify(e)))
                },
                ...
                sortColumn: function(e, a, n) {
                    ...
                    t(l).sort(function(e, o) {
                        ...
                        return n && (l = parseInt(l), r = parseInt(r)),
                ...
                localDataUpdate: function() {
                    ...
                    if (void 0 !== l && !0 !== i.getOption("data.serverSorting") ? "function" == typeof l.sortCallback ? o.dataSet = l.sortCallback(o.originalDataSet, n, l) : o.dataSet = i.sortCallback(o.originalDataSet, n, l) : o.dataSet = o.originalDataSet, "object" == typeof e.query && !i.getOption("data.serverFiltering")) {
                        ...
                        void 0 !== s && "" !== s && (s = s.toLowerCase(), o.dataSet = t.grep(o.dataSet, r), delete e.query[i.getGeneralSearchKey()]),
                        t.each(e.query,
                        function(t, a) {
                            "" === a && delete e.query[t]
                        }),
                ...
                getColumnByField: function(e) {
                    var a;
                    if (void 0 !== e) return t.each(n.columns,
                    function(t, n) {
                        if (e === n.field) return a = n,
                        !1
                    }),
                    a
                },
                ...
                getHiddenDimensions: function(e, a) {
                    ...
                    return i.each(function() {
                        var t = {};
                        for (var e in n) t[e] = this.style[e],
                        this.style[e] = n[e];
                        l.push(t)
                    }),
                    o.width = t(e).width(),
                ...
                redraw: function() {
                    ...
                    i.isLocked() && (i.scrollbar(), i.resetScroll(), i.adjustCellsHeight.call()),
                ...
                search: function(e, a) {
                    ...
                    o = function() {
                        ...
                        "object" == typeof a && (t.each(a,
                        function(t, a) {
                            o[a] = e
                        }), t.each(o,
                        function(e, a) { ("" === a || t.isEmptyObject(a)) && delete o[e]
                        })),
                ...
                hideColumn: function(e) {
                    ...
                    var a = t.grep(t(o.table).find(".m-datatable__cell"),
                    function(a, n) {
            ...
            n = t.extend(!0, {},
            t.fn.mDatatable.defaults, n), o.options = n, i.init.apply(this, [n]), t(o.wrap).data("mDatatable", o));
            else void 0 === (o = t(this).data("mDatatable")) && t.error("mDatatable not initialized"),
            n = o.options;
            return o
        }
    ...
    if (n) {
        ...
        l = {
            construct: function(t) {
                return mUtil.data(n).has("dropdown") ? a = mUtil.data(n).get("dropdown") : (l.init(t), l.setup(), mUtil.data(n).set("dropdown", a)),
                a
            },
            init: function(t) {
                a.options = mUtil.deepExtend({},
                i, t),
                a.events = [],
                a.eventHandlers = {},
                a.open = !1,
            ...
            show: function() {
                if ("hover" == a.options.toggle && mUtil.hasAttr(n, "hover")) return l.clearHovered(),
                a;
                if (a.open) return a;
...
mUtil.on(document, '[m-dropdown-toggle="hover"] .m-dropdown__toggle', "click",
function(t) {
...
function(t) {
    ...
    n = t.target;
    if (e = a.querySelectorAll(".m-dropdown.m-dropdown--open")) for (var o = 0,
    i = e.length; o < i; o++) {
        var l = e[o];
...
var mHeader = function(t, e) {
    ...
    if (void 0 !== n) {
        ...
        l = {
            construct: function(t) {
                return mUtil.data(n).has("header") ? a = mUtil.data(n).get("header") : (l.init(t), l.build(), mUtil.data(n).set("header", a)),
                a
            },
            init: function(t) {
                a.events = [],
            ...
            build: function() {
                var t = 0; ! 1 === a.options.minimize.mobile && !1 === a.options.minimize.desktop || window.addEventListener("scroll",
                function() {
                    var e, n, i, l = 0;
                    mUtil.isInResponsiveRange("desktop") ? (l = a.options.offset.desktop, e = a.options.minimize.desktop.on, n = a.options.minimize.desktop.off) : mUtil.isInResponsiveRange("tablet-and-mobile") && (l = a.options.offset.mobile, e = a.options.minimize.mobile.on, n = a.options.minimize.mobile.off),
...
mMenu = function(t, e) {
    ...
    if (o) {
        ...
        r = {
            construct: function(t) {
                return mUtil.data(o).has("menu") ? a = mUtil.data(o).get("menu") : (r.init(t), r.reset(), r.build(), mUtil.data(o).set("menu", a)),
                a
            },
            init: function(t) {
                a.events = [],
            ...
            getSubmenuMode: function(t) {
                return mUtil.isInResponsiveRange("desktop") ? t && mUtil.hasAttr(t, "m-menu-submenu-toggle") ? mUtil.attr(t, "m-menu-submenu-toggle") : mUtil.isset(a.options.submenu, "desktop.state.body") ? mUtil.hasClass(i, a.options.submenu.desktop.state.body) ? a.options.submenu.desktop.state.mode: a.options.submenu.desktop.
            default:
                mUtil.isset(a.options.submenu, "desktop") ? a.options.submenu.desktop: void 0 : mUtil.isInResponsiveRange("tablet") && mUtil.isset(a.options.submenu, "tablet") ? a.options.submenu.tablet: !(!mUtil.isInResponsiveRange("mobile") || !mUtil.isset(a.options.submenu, "mobile")) && a.options.submenu.mobile
            },
            isConditionalSubmenuDropdown: function() {
                return ! (!mUtil.isInResponsiveRange("desktop") || !mUtil.isset(a.options.submenu, "desktop.state.body"))
            },
            handleLinkClick: function(t) { ! 1 === r.eventTrigger("linkClick", this) && t.preventDefault(),
            ...
            handleSubmenuDrodownHoverEnter: function(t) {
                if ("accordion" !== r.getSubmenuMode(this) && !1 !== a.resumeDropdownHover()) {
                    "1" == this.getAttribute("data-hover") && (this.removeAttribute("data-hover"), clearTimeout(this.getAttribute("data-timeout")), this.removeAttribute("data-timeout")),
            ...
            handleSubmenuDropdownClose: function(t, e) {
                if ("accordion" !== r.getSubmenuMode(e)) {
                    ...
                    if (a.length > 0 && !1 === mUtil.hasClass(e, "m-menu__toggle") && 0 === e.querySelectorAll(".m-menu__toggle").length) for (var n = 0,
                    i = a.length; n < i; n++) r.hideSubmenuDropdown(a[0], !0)
                }
            },
            ...
            resetActiveItem: function(t) {
                for (var e, n, i = 0,
                l = (e = o.querySelectorAll(".m-menu__item--active")).length; i < l; i++) {
                    var r = e[0];
                    mUtil.removeClass(r, "m-menu__item--active"),
                    mUtil.hide(mUtil.child(r, ".m-menu__submenu"));
                    for (var s = 0,
                    d = (n = mUtil.parents(r, ".m-menu__item--submenu")).length; s < d; s++) {
                        var c = n[i];
...
function(t) {
    var e;
    if (e = mUtil.get("body").querySelectorAll('.m-menu__nav .m-menu__item.m-menu__item--submenu.m-menu__item--hover:not(.m-menu__item--tabs)[m-menu-submenu-toggle="click"]')) for (var a = 0,
    n = e.length; a < n; a++) {
        ...
        if (o) {
            ...
            if (t.target !== o && !1 === o.contains(t.target)) if (i = o.querySelectorAll('.m-menu__item--submenu.m-menu__item--hover:not(.m-menu__item--tabs)[m-menu-submenu-toggle="click"]')) for (var r = 0,
            s = i.length; r < s; r++) l.hideDropdown(i[r])
        }
    }
});
var mOffcanvas = function(t, e) {
    ...
    if (n) {
        ...
        l = {
            construct: function(t) {
                return mUtil.data(n).has("offcanvas") ? a = mUtil.data(n).get("offcanvas") : (l.init(t), l.build(), mUtil.data(n).set("offcanvas", a)),
                a
            },
            init: function(t) {
                a.events = [],
            ...
            build: function() {
                if (a.options.toggleBy) if ("string" == typeof a.options.toggleBy) mUtil.addEvent(a.options.toggleBy, "click", l.toggle);
                else if (a.options.toggleBy && a.options.toggleBy[0] && a.options.toggleBy[0].target) for (var t in a.options.toggleBy) mUtil.addEvent(a.options.toggleBy[t].target, "click", l.toggle);
            ...
            show: function(t) {
                "shown" != a.state && (l.eventTrigger("beforeShow"), l.togglerClass(t, "show"), mUtil.addClass(o, a.classShown), mUtil.addClass(n, a.classShown), a.state = "shown", a.options.overlay && (a.overlay = mUtil.insertAfter(document.createElement("DIV"), n), mUtil.addClass(a.overlay, a.classOverlay), mUtil.addEvent(a.overlay, "click",
                function(e) {
                    e.stopPropagation(),
                    e.preventDefault(),
                    l.hide(t)
...
mPortlet = function(t, e) {
    ...
    if (n) {
        ...
        r = {
            construct: function(t) {
                return mUtil.data(n).has("portlet") ? a = mUtil.data(n).get("portlet") : (r.init(t), r.build(), mUtil.data(n).set("portlet", a)),
                a
            },
            init: function(t) {
                a.element = n,
            ...
            fullscreen: function(t) {
                if ("off" === t || mUtil.hasClass(o, "m-portlet--fullscreen") && mUtil.hasClass(n, "m-portlet--fullscreen")) r.eventTrigger("beforeFullscreenOff"),
                mUtil.removeClass(o, "m-portlet--fullscreen"),
                mUtil.removeClass(n, "m-portlet--fullscreen"),
                r.removeTooltips(),
                r.setupTooltips(),
                a.foot && (mUtil.css(a.body, "margin-bottom", ""), mUtil.css(a.foot, "margin-top", "")),
...
mQuicksearch = function(t, e) {
    ...
    if (n) {
        ...
        r = {
            construct: function(t) {
                return mUtil.data(n).has("quicksearch") ? a = mUtil.data(n).get("quicksearch") : (r.init(t), r.build(), mUtil.data(n).set("quicksearch", a)),
                a
            },
            init: function(t) {
                a.element = n,
                ...
                "default" == a.options.mode && (a.iconSearch = mUtil.get(a.options.iconSearchTarget), a.iconCancel = mUtil.get(a.options.iconCancelTarget)),
            ...
            build: function() {
                ...
                "default" == a.options.mode ? (mUtil.addEvent(a.input, "focus", r.showDropdown), mUtil.addEvent(a.iconCancel, "click", r.handleCancel), mUtil.addEvent(a.iconSearch, "click",
                function() {
                    mUtil.isInResponsiveRange("tablet-and-mobile") && (mUtil.addClass(o, "m-header-search--mobile-expanded"), a.input.focus())
                }), mUtil.addEvent(a.iconClose, "click",
                function() {
            ...
            search: function(t) {
                if (a.query = a.input.value, 0 === a.query.length && (r.handleCancelIconVisibility("on"), mUtil.removeClass(n, a.options.hasResultClass), mUtil.removeClass(a.form, a.options.spinnerClass)), !(a.query.length < a.options.minLength || 1 == a.processing)) return a.requestTimeout && clearTimeout(a.requestTimeout),
                a.requestTimeout = !1,
...
mScrollTop = function(t, e) {
    ...
    if (n) {
        ...
        l = {
            construct: function(t) {
                return mUtil.data(n).has("scrolltop") ? a = mUtil.data(n).get("scrolltop") : (l.init(t), l.build(), mUtil.data(n).set("scrolltop", a)),
                a
            },
            init: function(t) {
                a.events = [],
            ...
            build: function() {
                navigator.userAgent.match(/iPhone|iPad|iPod/i) ? (window.addEventListener("touchend",
                function() {
                    l.handle()
...
mToggle = function(t, e) {
    ...
    if (n) {
        ...
        l = {
            construct: function(t) {
                return mUtil.data(n).has("toggle") ? a = mUtil.data(n).get("toggle") : (l.init(t), l.build(), mUtil.data(n).set("toggle", a)),
                a
            },
            init: function(t) {
                a.element = n,
...
mWizard = function(t, e) {
    ...
    if (n) {
        ...
        l = {
            construct: function(t) {
                return mUtil.data(n).has("wizard") ? a = mUtil.data(n).get("wizard") : (l.init(t), l.build(), mUtil.data(n).set("wizard", a)),
                a
            },
            init: function(t) {
                a.element = n,
            ...
            build: function() {
                ...
                mUtil.addEvent(a.btnPrev, "click",
                function(t) {
                    t.preventDefault(),
                    l.goPrev()
                }),
                mUtil.addEvent(a.btnFirst, "click",
                function(t) {
                    t.preventDefault(),
                    l.goFirst()
                }),
                mUtil.addEvent(a.btnLast, "click",
                function(t) {
                    t.preventDefault(),
                    l.goLast()
                }),
                mUtil.on(n, ".m-wizard__step a.m-wizard__step-number", "click",
                function() {
            ...
            goTo: function(t) {
                if (! (t === a.currentStep || t > a.totalSteps || t < 0)) {
                    var e;
                    if (e = (t = t ? parseInt(t) : l.getNextStep()) > a.currentStep ? l.eventTrigger("beforeNext") : l.eventTrigger("beforePrev"), !0 !== a.stopped) return ! 1 !== e && (l.eventTrigger("beforeChange"), a.currentStep = t, l.updateUI(), l.eventTrigger("change")),
            ...
            updateUI: function(t) {
                ...
                l.setStepClass();
                for (var e = 0,
                n = a.steps.length; e < n; e++) mUtil.removeClass(a.steps[e], "m-wizard__step--current m-wizard__step--done");
...
function(t) {
    ...
    t.fn.mDatatable.checkbox = function(e, a) {
        var n = {
            ...
            unselectedRows: [],
            init: function() {
                n.selectorEnabled() && (e.setDataSourceParam(a.vars.selectedAllRows, !1), e.stateRemove("checkbox"), a.vars.requestIds && e.setDataSourceParam(a.vars.requestIds, !0), t(e).on("m-datatable--on-reloaded",
                function() {
                    ...
                    n.selectedRows = [],
                    n.unselectedRows = []
                }), n.selectedAllRows = e.getDataSourceParam(a.vars.selectedAllRows), t(e).on("m-datatable--on-layout-updated",
                function(a, o) {
        ...
        "object" == typeof a && (a = t.extend(!0, {},
        t.fn.mDatatable.checkbox.
    default, a), n.init.apply(this, [a])),
        e
    },
    t.fn.mDatatable.checkbox.
default = {
...
var mLayout = function() {
    ...
    return {
        ...
        initHeader: function() {
            ...
            o.minimize.mobile.on = "m-header--hide", o.minimize.mobile.off = "m-header--show") : o.minimize.mobile = !1,
            "hide" == mUtil.attr(a, "m-minimize") ? (o.minimize.desktop = {},
            o.minimize.desktop.on = "m-header--hide", o.minimize.desktop.off = "m-header--show") : o.minimize.desktop = !1,
        ...
        initAside: function() {
            ...
            mUtil.hasClass(s, "m-aside-left--fixed") && (mUtil.addEvent(d, "mouseenter",
            function() {
            ...
            function(t) {
                var e = mUtil.get("body"); ! 1 === mUtil.hasClass(e, "m-aside-left--minimize") && mUtil.hasClass(e, "m-aside-left--minimize-hover") && mUtil.removeClass(e, "m-aside-left--minimize-hover")
            })),
            l(),
